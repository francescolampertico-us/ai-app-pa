...
Two-step LLM pipeline:
  Step 1 — gpt-4o builds the Message House (strategic foundation)
  Step 2 — gpt-4o-mini generates each platform variant (format adaptation)
...
def generate_message_house(client: OpenAI, position: str, context: str = "",
    ...
    """Step 1: Generate the Message House via gpt-4o."""
...
def generate_variant(client: OpenAI, variant_id: str, house: dict,
    ...
    """Step 2: Generate a single platform variant via gpt-4o-mini."""
