...
python3 toolkit/tools/hearing_memo/execution/run.py \
  --input toolkit/tools/hearing_memo/eval/inputs/case_02_transcript_noisy.txt \
  --output toolkit/tools/hearing_memo/eval/runs/case_02/memo.docx \
  --json-output toolkit/tools/hearing_memo/eval/runs/case_02/bundle.json \
  --text-output toolkit/tools/hearing_memo/eval/runs/case_02/memo.md
```
