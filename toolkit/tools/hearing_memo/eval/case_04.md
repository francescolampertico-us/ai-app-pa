...
python3 toolkit/tools/hearing_memo/execution/run.py \
  --input toolkit/tools/hearing_memo/eval/inputs/case_04_transcript_qa_excerpt.txt \
  --output toolkit/tools/hearing_memo/eval/runs/case_04/memo.docx \
  --json-output toolkit/tools/hearing_memo/eval/runs/case_04/bundle.json \
  --text-output toolkit/tools/hearing_memo/eval/runs/case_04/memo.md
```
