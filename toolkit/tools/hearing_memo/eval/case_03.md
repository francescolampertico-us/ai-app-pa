...
python3 toolkit/tools/hearing_memo/execution/run.py \
  --input toolkit/tools/hearing_memo/eval/inputs/case_03_transcript_excerpt.txt \
  --output toolkit/tools/hearing_memo/eval/runs/case_03/memo.docx \
  --json-output toolkit/tools/hearing_memo/eval/runs/case_03/bundle.json \
  --text-output toolkit/tools/hearing_memo/eval/runs/case_03/memo.md
```
