...
python3 -m pip install -r toolkit/tools/hearing_memo/requirements.txt
```
...
python3 toolkit/tools/hearing_memo/execution/run.py \
  ...
  --output toolkit/tools/hearing_memo/eval/runs/case_01/memo.docx \
  --json-output toolkit/tools/hearing_memo/eval/runs/case_01/bundle.json \
  --text-output toolkit/tools/hearing_memo/eval/runs/case_01/memo.md
```
